...
static int indice;
MASK masc1, masc2, masc_missiles, masc_planet, mascAux; /*ADICIONEI UMA MASCARA AUXILIAR*/
...
void init_modulo_grafico(){
    ...
    GeraFundo();
    P1 = ReadPic( w, "spaceshuttle_bw1.xpm", mascAux); /*JOGUEI OS DADOS DA MASCARA DA IMAGEM EM "MASCAUX" */
